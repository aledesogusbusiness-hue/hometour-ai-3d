      ...
      <section class="hero">
        ...
        <div class="viewer-wrap" id="viewerWrap">
          ...
          <div class="viewer-error" id="viewerError" hidden>
            ...
            <span>Run the project with <code>npm install</code> and <code>npm run dev</code>.</span>
          </div>
        </div>
      </section>
...
async function init3D() {
  try {
    ...
    // The supplied capture is treated as the master spatial asset.
    ...
    // Give the browser a moment to initialize the GPU before removing the loader.
